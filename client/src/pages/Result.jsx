...
const Result = () => {
  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className="bg-white px-8 py-6 rounded-lg drop-shadow-md">
        ...
        {resultImage && (
          <div className="flex justify-center sm:justify-end items-center gap-4 mt-6 flex-wrap">
            <button className="px-8 py-2.5 text-violet-600 border border-violet-600 rounded-full text-sm hover:scale-105 transition-all duration-700">
              Try another image
            </button>
            <a
